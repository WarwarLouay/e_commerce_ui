                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: () {update(favoriteItem.favoriteItem[index]['product']['_id']);},
                        child: Icon(
                          Icons.favorite,
                          color: Colors.red,
                        ),
                  ...
                  InkWell(
                    onTap: () {
                      Navigator.pushNamed(context, 'itemPage', arguments: {
                        'id': favoriteItem.favoriteItem[index]['product']['_id'],
                        'image': favoriteItem.favoriteItem[index]['product']
                            ['productImage'],
                        'name': favoriteItem.favoriteItem[index]['product']
                            ['productName'],
                        'description': favoriteItem.favoriteItem[index]
                            ['product']['productDescription'],
                        'price': favoriteItem.favoriteItem[index]['product']
                            ['productPrice'],
                      });
                    },
                    child: Container(
                        ...
                        InkWell(
                          onTap: () async {
                            await Provider.of<Cart>(context, listen: false)
                                .addToCart(
                                    favoriteItem.favoriteItem[index]['product']['_id'], 1);
                          },
                          child: Icon(
